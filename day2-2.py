...
input = """16-18 h: hhhhhhhhhhhhhhhhhh
...
valid_count = 0
checker = r"([0-9]+)\-([0-9]+)\s([a-zA-Z]+):\s([a-zA-Z]+)"

arr = input.split("\n")

for data in arr:
    if data != '':
        parts = re.findall(checker, data)
        #print(parts)
        ...
        if (passwd[lower-1] == char or passwd[upper-1] == char) and passwd[lower-1] != passwd[upper-1]:
            valid_count = valid_count + 1

print("valid strings2: ", valid_count)
